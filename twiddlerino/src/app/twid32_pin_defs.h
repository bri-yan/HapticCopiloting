...
#define PIN_CURRENT_SENS_1_ANALOG  gpio_num_t::GPIO_NUM_34 //this pin goes to channel ADC1_6
#define PIN_CURRENT_SENS_2_ANALOG  gpio_num_t::GPIO_NUM_15 //this pin goes to channel ADC1_7
